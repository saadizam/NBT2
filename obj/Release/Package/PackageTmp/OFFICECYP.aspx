<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OFFICECYP.aspx.cs" Inherits="WEB.OFFICECYP" %>
            ...
            <asp:Panel ID="Panel2" runat="server" Direction="LeftToRight" Height="183px" Width="769px">
                <table class="auto-style13">
                    ...
                    <tr>
                        ...
                        <td class="auto-style63">
                            <asp:TextBox ID="TextBox5" runat="server" Width="123px"></asp:TextBox>
                        </td>
                        <td class="auto-style81">Extra Drop:&nbsp; &nbsp;&nbsp;</td>
                        <td class="auto-style6">
                            <asp:TextBox ID="TextBox7" runat="server" Width="123px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="auto-style61">Minimum Price </td>
                        <td class="auto-style63">
                            <asp:TextBox ID="TextBox6" runat="server" Width="123px"></asp:TextBox>
                        </td>
                        <td class="auto-style81">V.A.T Rate :&nbsp; </td>
                        <td class="auto-style6">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <table class="auto-style32">
                    <tr>
                        ...
                        <td class="auto-style73">
                            <asp:Button ID="TableGenerate" runat="server" BackColor="#000066" Font-Bold="True" ForeColor="White" OnClick="TableGenerate_Click" Text="Show Table" Width="161px" />
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style56" colspan="2">
                            ...
                            <asp:GridView ID="GridView3" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="1" DataKeyNames="No" DataSourceID="SqlDataSource4" EmptyDataText="There are no data records to display." GridLines="Vertical" Width="752px">
                                <AlternatingRowStyle BackColor="#DCDCDC" />
                                <Columns>
            ...
            <strong>
            <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:BuzybeezWebConnectionString %>" DeleteCommand="DELETE FROM [VExexcutive] WHERE [No] = @No" InsertCommand="INSERT INTO [VExexcutive] ([No], [AccountName], [Vehiclename], [Unit], [Cost], [OfficeName]) VALUES (@No, @AccountName, @Vehiclename, @Unit, @Cost, @OfficeName)" SelectCommand="SELECT [No], [AccountName], [Vehiclename], [Unit], [Cost], [OfficeName] FROM [VExexcutive] WHERE (([AccountName] = @AccountName) AND ([Vehiclename] = @Vehiclename)) ORDER BY [AccountName], [Unit], [Cost] DESC" UpdateCommand="UPDATE [VExexcutive] SET [AccountName] = @AccountName, [Vehiclename] = @Vehiclename, [Unit] = @Unit, [Cost] = @Cost, [OfficeName] = @OfficeName WHERE [No] = @No">
                <DeleteParameters>
                    <asp:Parameter Name="No" Type="Int32" />
                </DeleteParameters>
                <InsertParameters>
